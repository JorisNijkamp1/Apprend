...
const InfiniteScrollResults = (props) => {
    ...
    const fetchMoreData = () => {
        ...
        setTimeout(() => {
            fetchDecks(searchValue, currentPage)
                .then(result => {
                                    ...
                                    <Card.Body>
                                        ...
                                        <strong>
                                            <Link id="creator" to={`/Aaron/decks`}>
                                                ...
                                                />
                                                <span
                                                    style={{marginLeft: 5, color: '#000'}}>{deck.deckCreator}</span>
                                            </Link>
                                            <span className={'float-right'} style={{color: '#000'}}>
                                                    <span
                                                        className={'font-weight-bold'}>Flashcards: {deck.totalFlashcards}</span>
                                                </span>
                                        </strong>
                                    </Card.Body>
                                </Card>
